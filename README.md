...
#### Задача 2. Перенесите написанный код без тегов <script> во вкладку script.js. Затем пропишите путь к файлу "script.js" в атрибуте src. Так JS-код будет исполняться из отдельного файла.
