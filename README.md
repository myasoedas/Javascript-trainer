# trenazher - задачки по JavaScript по нарастающей сложности

## Курс "Веб разработчик" от Яндекс Практикума

#### Задача 6. 
* Трём верстальщикам нужно сверстать 20 макетов за спринт. 
* Они решили разделить макеты поровну, чтобы каждый сделал одинаковое число макетов.
* Верстальщики вредные — никто из них не хочет делать хоть на один макет больше другого.
* Выведите в консоль, сколько макетов останутся неподготовленными из-за вредности верстальщиков.
